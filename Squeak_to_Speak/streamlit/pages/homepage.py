...
with st.container():
    ...
    col1, col2, col3 = st.columns(3)
    with col1:
        st.markdown("<mark style='background-color:#f99dc6'>I was hesitant to seek therapy, but Squeak to Speak helped me take the first step. Anna P.</mark>", unsafe_allow_html=True)

    with col2:
        st.markdown("<mark style='background-color:#f99dc6'>The personalized advice I received gave me confidence. James R.</mark>", unsafe_allow_html=True)

    with col3:
        st.markdown("<mark style='background-color:#f99dc6'>Having someone to talk to 24/7 has been a game-changer. Marta S.</mark>", unsafe_allow_html=True)
