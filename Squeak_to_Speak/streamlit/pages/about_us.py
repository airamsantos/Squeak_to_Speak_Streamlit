...
lottie_animation = load_lottiefile("Squeak_to_Speak/streamlit/visual_assets/person.json")  

with st.container():
    col1, col3, col5 = st.columns((4, 5, 1))
    with col3:
        st.image(r"Squeak_to_Speak/streamlit/visual_assets/ratinho_rosa.png", width=150)
...
with st.container():
    ...
    with img:
        st.image(r"Squeak_to_Speak/streamlit/visual_assets/paisagens.png", width=310)
st.divider()
...
with st.container():
    ...
    with col6:
        ...
        with col1:
                st.image(r"Squeak_to_Speak/streamlit/visual_assets/rato_3.png", width=50)
                st.image(r"Squeak_to_Speak/streamlit/visual_assets/rato_4.png", width=50)
                st.image(r"Squeak_to_Speak/streamlit/visual_assets/rato_2.png", width=50)
        with col2: 
                st.write("""
        ...
        with col3:
                st.image(r"Squeak_to_Speak/streamlit/visual_assets/rato_5.png", width=50)
                st.image(r"Squeak_to_Speak/streamlit/visual_assets/rato_1.png", width=50)
        with col4:
            st.write("""  
